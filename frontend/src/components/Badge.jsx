...
const VARIANT_CLASSES = {
  ...
  dirty: 'bg-red-50 text-red-600 border border-red-200',
  blocked: 'bg-gray-100 text-gray-500 border border-gray-200',
  en_proceso: 'bg-yellow-50 text-yellow-700 border border-yellow-200',
  precio: 'bg-blue-50 text-blue-700 border border-blue-200',
  ocupacion: 'bg-green-50 text-green-700 border border-green-200',
  ...
  trabajando: 'bg-green-50 text-green-700 border border-green-200',
  fuera: 'bg-gray-100 text-gray-600 border border-gray-200',
  sin_fichar: 'bg-yellow-50 text-yellow-700 border border-yellow-200',
  wifi: 'bg-green-50 text-green-700 border border-green-200',
  gps: 'bg-green-50 text-green-700 border border-green-200',
  out_of_zone: 'bg-red-50 text-red-600 border border-red-200',
